...
Deno.test(
   "parse certificate",
   ()=>{
      const certificate = toUint8Array(`0b 00 01 b9 00 00 01 b5 00 01 b0 30 82
      ...
      const test = Handshake.parse(certificate);
      assertEquals(test.toString(), certificate.toString())
   }
)
